...
source(here("scripts", "R", "1_processing_fun.R"), encoding = "UTF-8")
...
source(here("scripts", "R", '2_first_dates_fun.R'), encoding = 'UTF-8')
...
source(here("scripts", "R", '2c_first_dates_nonprocessed.R'), encoding = 'UTF-8')
...
dirs <-  list(pre = create_dirs_preprocess(start_year = start_year, end_year = end_year, longitudinal = T),
       ad0 = c(create_dirs_postprocess(add_days = 0, start_year = start_year, end_year = end_year, longitudinal = T),
               create_dirs_first_dates(add_days = 0, start_year = start_year, end_year = end_year, longitudinal = T)),
       ad1 = c(create_dirs_postprocess(add_days = 1, start_year = start_year, end_year = end_year, longitudinal = T),
               create_dirs_first_dates(add_days = 1, start_year = start_year, end_year = end_year, longitudinal = T))
)
